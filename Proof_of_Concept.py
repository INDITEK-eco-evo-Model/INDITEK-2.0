...
from inditek_gridding_alphadiv import inditek_gridding_alphadiv
...
params_proposed = [161, 0.035, 1.75, 0, 0]
...
[rho_shelf,K_shelf, ext_index]=rhonet_evo(kfood,Kmin,food_shelf,temp_shelf,ext_pattern,params_proposed[0],spec_min_mean,params_proposed[1], params_proposed[2],params_proposed[3],params_proposed[4],shelf_lonlatAge,Point_timeslices[0])
